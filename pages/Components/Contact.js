...
const Contact = () => {
  return (
    <div id='contact' className='w-full lg:h-screen'>
        <div className='max-w-[1240px] m-auto px-2 py-16 w-full pt-96'>
...
<div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
    <div className='lg:p-4 h-full'>
        <div>
            ...
            src='/../public/assets/AV.jpg'
            width='380'
            height='50' 
            alt='Picture' />
        </div>
        <div>
            <h2 className='py-2'>Amisha Vishvakarma</h2>
...
{/* right */}
<div className='col-span-3 w-full h-auto shadow-xl shadow-gray-400 riunded-xl lg:p-4'>
    <div className='p-4'>
  ...
  <form>
        <div className='grid md:grid-cols-2 gap-4 w-full py-2'>
            ...
            <div className='flex flex-col'>
            <label className='uppercase text-sm py-2'>Mobaile Number</label>
            <input 
            className='border-2 rounded-lg p-3 flex border-gray-300'
            type="text" 
            />

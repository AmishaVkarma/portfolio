...
const Navbar = () => {
  ...
  return (
    <div className={shadow ?'fixed w-full h-28 shadow-xl z-[100] ' : 'fixed w-full h-28 z-[100] '}> 
        <div className='flex justify-between item-center h-full w-full px-2 2xl:px-16'>
           <Link href='/'>
           <Image 
        ...
        <div className= {
            ...
            <div>
                ...
                <div className='border-b border-gray-300 my-4'>
                    <p className='w-[85%] md:w-[95%] py-4'> Let's build something legendary together</p>
                </div>
